// src/lib.rs
/*
 * Core library for MiddlewareChain
 */
...
#[derive(Debug)]
pub struct MiddlewareChainProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MiddlewareChainProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MiddlewareChain processing");
    
    let mut processor = MiddlewareChainProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MiddlewareChainProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MiddlewareChainProcessor::new(false);
